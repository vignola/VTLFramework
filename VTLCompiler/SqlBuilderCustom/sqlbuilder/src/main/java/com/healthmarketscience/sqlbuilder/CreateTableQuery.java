...
public class CreateTableQuery extends BaseCreateQuery<CreateTableQuery> {
    ...
    public CreateTableQuery setAsSelect(Subquery selectQuery) {
        this._sqlObject = selectQuery;
        return this;
    }

    public CreateTableQuery setAsCustomSelect(Object objectQuery) {
        this._sqlObject = Converter.toSubquery(objectQuery);
        return this;
    }
    ...
    protected void appendTo(AppendableExt app, SqlContext newContext)
        ...
        customAppendTo(app, Hook.TABLE, "TABLE ").append(_object);
     ...
     */
    private static class ConstrainedColumn extends SqlObject implements Serializable {
