...
public class AlterTableQuery extends Query<AlterTableQuery>
{
   ...
   */
  public static class AddConstraintAction extends SqlObject implements Serializable
  {
   ...
   * @author Eric Fennell
   */
  public static class AddColumnAction extends SqlObject implements Serializable
  {
