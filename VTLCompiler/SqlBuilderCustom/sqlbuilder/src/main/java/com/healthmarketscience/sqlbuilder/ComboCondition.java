 ...
 */
public class ComboCondition extends Condition implements Serializable
{
  /**
  ...
  public ComboCondition addConditions(Condition... conditions) {
     ...
     * Adds the given conditions to the list of conditions.
     */
    public ComboCondition addConditionsList(List<Condition> conditions) {
        return addCustomConditions((Object[]) conditions.toArray());
    }
