...
public class FunctionCall extends Expression
{
  ...
  public FunctionCall addAlias(String alias) {
    this.alias = alias;
    return this;
  }
  ...
  public FunctionCall addCustomParams(List<Object> params) {
    _params.addObjects(Converter.COLUMN_VALUE_TO_OBJ, params.toArray());
    return this;
  }
  ...
  public void appendTo(AppendableExt app) throws IOException {
    ...
    public static FunctionCall customFunction(String customOperator) {
    return new FunctionCall(new CustomSql(customOperator));
  }
  /**
  ...
  public static FunctionCall rtrim() {
    return new FunctionCall(new CustomSql("RTRIM"));
  }
