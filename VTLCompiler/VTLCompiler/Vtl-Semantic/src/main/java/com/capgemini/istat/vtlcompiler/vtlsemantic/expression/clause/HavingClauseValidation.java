...
@Component
@Scope("prototype")
public class HavingClauseValidation implements OperatorValidation {
    ...
    public LinkedList<ResultExpression> resolve(Map<KeyVariables, Object> variables) throws Exception {
        LinkedList<ResultExpression> resultExpressions = semanticFactory.checkSemantic(vtlHavingClauseExpression.getVtlExpression(), variables);
        ResultExpression resultExpression = functionResultService.getHavingresult(vtlHavingClauseExpression);
