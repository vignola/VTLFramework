...
public class VtlSemanticTimeOperatorsTest {
...
//	op non ha identificativi di tipo time_period 
	...
	public void periodIndicator() throws Exception {
		...
		if (vtlDatasetFind == null) {
			...
			vtlDataset.addComponent(vtlTestUtils.getVtlComponent("ID_3", VtlType.NUMBER, VtlComponentRole.IDENTIFIER));
...
//	op ha più di un identificativo di tipo time_period

	@Test
	@Transactional
	public void periodIndicatorControlloDue() throws Exception {
		VtlDataset vtlDatasetFind = datasetRepository.findByNameIgnoreCase("DS_1");
		if (vtlDatasetFind == null) {
			VtlDataset vtlDataset = new VtlDataset();
			...
			vtlDataset.addComponent(
					vtlTestUtils.getVtlComponent("ID_1", VtlType.TIME_PERIOD, VtlComponentRole.IDENTIFIER));
			vtlDataset.addComponent(vtlTestUtils.getVtlComponent("ID_2", VtlType.INTEGER, VtlComponentRole.IDENTIFIER));
			vtlDataset.addComponent(
...
//  	op non è di tipo time_period
	...
	public void periodIndicatorComponent() throws Exception {
		...
		String commandStatements = "DS_r := DS_39 [ filter period_indicator ( Id_1 ) = \"A\" ]";
...
//	op non ha identificativi di tipo time 
	...
	public void fillTimeSeriesSingle() throws Exception {
		...
		if (vtlDatasetFind == null) {
			...
			vtlDataset.setTransitory(false);
			vtlDataset.addComponent(vtlTestUtils.getVtlComponent("ID_1", VtlType.STRING, VtlComponentRole.IDENTIFIER));
			vtlDataset.addComponent(vtlTestUtils.getVtlComponent("ID_2", VtlType.NUMBER, VtlComponentRole.IDENTIFIER));
...
//	ha più di un identificativo di tipo time
...
//	ha più di un identificativo di tipo time
	...
	@Test
	@Transactional
	public void flowToStockControlloDue() throws Exception {
		VtlDataset vtlDatasetFind = datasetRepository.findByNameIgnoreCase("DS_1");
		if (vtlDatasetFind == null) {
			VtlDataset vtlDataset = new VtlDataset();
...
//	ha più di un identificativo di tipo time
	...
	@Test
	@Transactional
	public void stockToFlowControlloDue() throws Exception {
		VtlDataset vtlDatasetFind = datasetRepository.findByNameIgnoreCase("DS_1");
		if (vtlDatasetFind == null) {
			VtlDataset vtlDataset = new VtlDataset();
		...
		String commandStatements = "DS_r := stock_to_flow ( DS_24 );";
...
//	ha più di un identificativo di tipo time
	...
	@Test
	@Transactional
	public void timeshiftControlloDue() throws Exception {
		VtlDataset vtlDatasetFind = datasetRepository.findByNameIgnoreCase("DS_1");
		if (vtlDatasetFind == null) {
			VtlDataset vtlDataset = new VtlDataset();
...
//	shiftNumber non è di tipo integer

	@Test
	@Transactional
	public void timeshiftControlloTre() throws Exception {
		VtlDataset vtlDatasetFind = datasetRepository.findByNameIgnoreCase("DS_1");
		if (vtlDatasetFind == null) {
			VtlDataset vtlDataset = new VtlDataset();
		...
		String commandStatements = "DS_r := timeshift ( DS_22 , ciao  );";
	...
	//il dataset op non ha un identificativo di tipo time
	...
	public void timeAgg() throws Exception {
		...
		String commandStatements = "DS_r := sum ( DS_35 group all time_agg ( \"A\" , _ , Me_1 ));";
	...
	@Test
	@Transactional
	public void timeAggControlloDue() throws Exception {
		VtlDataset vtlDatasetFind = datasetRepository.findByNameIgnoreCase("DS_1");
		if (vtlDatasetFind == null) {
			VtlDataset vtlDataset = new VtlDataset();
        ...
        //il dataset op ha misure che sono di tipo diverso da number

	@Test
	@Transactional
	public void timeAggControlloTre() throws Exception {
		VtlDataset vtlDatasetFind = datasetRepository.findByNameIgnoreCase("DS_1");
		if (vtlDatasetFind == null) {
			VtlDataset vtlDataset = new VtlDataset();
