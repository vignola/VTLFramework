...
@Component
@Scope("prototype")
public class BooleanUnaryTranslation implements OperatorTranslation {

    private VtlBooleanUnaryExpression vtlBooleanUnaryExpression;
    ...
    public void setVtlExpression(VtlExpression vtlExpression) {
        this.vtlBooleanUnaryExpression = (VtlBooleanUnaryExpression) vtlExpression;
    }
    ...
    public SqlResult translate(Map<KeyVariables, Object> variables) throws Exception {
        SqlResult sqlResultTranslate = translationFactory.translate(vtlBooleanUnaryExpression.getVtlExpression(), variables);
        Boolean isWhereCondition = (Boolean) variables.getOrDefault(KeyVariables.FILTER_CLAUSE, false);
        SqlResult sqlResultUnary;
        if (isWhereCondition) {
            sqlResultUnary = sqlResultService.applyUnaryCondition(vtlBooleanUnaryExpression, sqlResultTranslate);   
        } else {
            sqlResultUnary = sqlResultService.applyUnaryFunction(vtlBooleanUnaryExpression, sqlResultTranslate);
        }
